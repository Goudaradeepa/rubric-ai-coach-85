...
const navItems = [
  { path: "/", label: "Teacher Dashboard", icon: BookOpen },
  { path: "/submit", label: "Student Submission", icon: GraduationCap },
  { path: "/results", label: "Evaluation Results", icon: ClipboardCheck },
